...
export default function Footer() {
  ...
  <nav>
    <div className="grid grid-flow-col gap-4">
      <a href='https://x.com/sadiaafrin0920' target="_blank"  rel="noopener noreferrer">
        <svg
      ...
      <a href='https://www.facebook.com/sadia.afrin.khan.52' target="_blank"  rel="noopener noreferrer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
